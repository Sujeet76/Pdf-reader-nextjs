    ...
    <>
      <MaxWidthWrapper className="bg-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Quill allows you to have conversation with any PDG document. Simply
      ...
      <div>
        <div className="relative isolate">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="mt-16 flow-root sm:mt-">
              <div className="-mt-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-mt-4  lg:rounded-2xl lg:p-4">
                <Image
